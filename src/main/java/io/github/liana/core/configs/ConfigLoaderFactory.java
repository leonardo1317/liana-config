...
import static io.github.liana.core.configs.FileExtensionValidator.isValid;
...
class ConfigLoaderFactory {
    ...
    public static ConfigWrapper fromFile(ConfigResource resource) {
        ...
        return strategies.stream()
                ...
                .findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Unsupported config file: " + resource.getFilename()))
                .load(resource);
    }
